 ...
 */
namespace EbayVendor\PHP_CodeSniffer\Tests\Core\File;

use EbayVendor\PHP_CodeSniffer\Tests\Core\AbstractMethodUnitTest;
class GetMethodPropertiesTest extends AbstractMethodUnitTest
{
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'EbayVendor\\MyNamespace\\MyClass', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'EbayVendor\\MyNamespace\\MyClass\\Foo', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'EbayVendor\\?namespace\\Name', 'nullable_return_type' => \true, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'EbayVendor\\MyClassA|\\Package\\MyClassB', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
    ...
    */
    ...
    {
        $expected = ['scope' => 'public', 'scope_specified' => \false, 'return_type' => 'EbayVendor\\MyClassA&\\Package\\MyClassB&\\Package\\MyClassC', 'nullable_return_type' => \false, 'is_abstract' => \false, 'is_final' => \false, 'is_static' => \false, 'has_body' => \true];
        $this->getMethodPropertiesTestHelper('/* ' . __FUNCTION__ . ' */', $expected);
    }
