...
class RuleInclusionAbsoluteWindowsTest extends TestCase
{
    ...
    public function testWindowsStylePathRuleInclusion()
    {
        ...
        $this->assertSame('EbayVendor\\PHP_CodeSniffer\\Standards\\Generic\\Sniffs\\Formatting\\SpaceAfterCastSniff', $this->ruleset->sniffCodes['Generic.Formatting.SpaceAfterCast']);
