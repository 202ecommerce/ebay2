 ...
 */
namespace EbayVendor\PHP_CodeSniffer;

use EbayVendor\PHP_CodeSniffer\Exceptions\DeepExitException;
use EbayVendor\PHP_CodeSniffer\Exceptions\RuntimeException;
use EbayVendor\PHP_CodeSniffer\Files\DummyFile;
use EbayVendor\PHP_CodeSniffer\Files\File;
use EbayVendor\PHP_CodeSniffer\Files\FileList;
use EbayVendor\PHP_CodeSniffer\Util\Cache;
use EbayVendor\PHP_CodeSniffer\Util\Common;
use EbayVendor\PHP_CodeSniffer\Util\Standards;
class Runner
{
    /**
