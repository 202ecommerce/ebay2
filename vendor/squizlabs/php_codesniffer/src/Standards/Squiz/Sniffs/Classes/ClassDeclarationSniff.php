 ...
 */
namespace EbayVendor\PHP_CodeSniffer\Standards\Squiz\Sniffs\Classes;

use EbayVendor\PHP_CodeSniffer\Files\File;
use EbayVendor\PHP_CodeSniffer\Standards\PSR2\Sniffs\Classes\ClassDeclarationSniff as PSR2ClassDeclarationSniff;
