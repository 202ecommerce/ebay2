 ...
 */
namespace EbayVendor\PHP_CodeSniffer\Files;

use EbayVendor\PHP_CodeSniffer\Autoload;
use EbayVendor\PHP_CodeSniffer\Util;
...
use EbayVendor\ReturnTypeWillChange;
class FileList implements \Iterator, \Countable
{
    ...
    private function getFilterClass()
    {
        ...
        if ($filterType === null) {
            $filterClass = 'EbayVendor\\PHP_CodeSniffer\\Filters\\Filter';
        } else {
