 ...
 */
namespace EbayVendor\PhpCsFixer\Diff\v3_0;

use EbayVendor\PhpCsFixer\Diff\v3_0\Output\DiffOutputBuilderInterface;
use EbayVendor\PhpCsFixer\Diff\v3_0\Output\UnifiedDiffOutputBuilder;
/**
 * Diff implementation.
 */
final class Differ
