 ...
 */
namespace EbayVendor\League\OAuth2\Client\Grant;

use EbayVendor\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'EbayVendor\\League\\OAuth2\\Client\\Grant\\' . $class;
