...
namespace EbayVendor\Psr\Log\Test;
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('EbayVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('EbayVendor\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
