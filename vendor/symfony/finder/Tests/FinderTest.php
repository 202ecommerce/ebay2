 ...
 */
namespace EbayVendor\Symfony\Component\Finder\Tests;
...
class FinderTest extends Iterator\RealIteratorTestCase
{
    ...
    {
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Finder\\Finder', Finder::create());
    }
    ...
    {
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Finder\\Finder', Finder::create()->append([]));
    }
    ...
    public function testAccessDeniedException()
    {
        ...
        if (\false === ($couldRead = \is_readable($testDir))) {
            try {
                ...
                $expectedExceptionClass = 'EbayVendor\\Symfony\\Component\\Finder\\Exception\\AccessDeniedException';
                if ($e instanceof \EbayVendor\PHPUnit\Framework\ExpectationFailedException) {
                    $this->fail(\sprintf("Expected exception:\n%s\nGot:\n%s\nWith comparison failure:\n%s", $expectedExceptionClass, 'EbayVendor\\PHPUnit\\Framework\\ExpectationFailedException', $e->getComparisonFailure()->getExpectedAsString()));
                }
