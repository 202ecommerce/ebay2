 ...
 */
namespace EbayVendor\Symfony\Component\Finder\Tests\Iterator;
...
class FilecontentFilterIteratorTest extends IteratorTestCase
{
    ...
    public function getTestFilterData()
    {
        ...
        $inner[] = new MockSplFileInfo(['name' => 'a.txt', 'contents' => 'Lorem ipsum...', 'type' => 'file', 'mode' => 'r+']);
        $inner[] = new MockSplFileInfo(['name' => 'b.yml', 'contents' => 'dolor sit...', 'type' => 'file', 'mode' => 'r+']);
        $inner[] = new MockSplFileInfo(['name' => 'some/other/dir/third.php', 'contents' => 'amet...', 'type' => 'file', 'mode' => 'r+']);
        $inner[] = new MockSplFileInfo(['name' => 'unreadable-file.txt', 'contents' => \false, 'type' => 'file', 'mode' => 'r+']);
