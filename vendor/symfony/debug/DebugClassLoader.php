...
use EbayVendor\PHPUnit\Framework\MockObject\Matcher\StatelessInvocation;
@\trigger_error(\sprintf('The "%s" class is deprecated since Symfony 4.4, use "%s" instead.', DebugClassLoader::class, \EbayVendor\Symfony\Component\ErrorHandler\DebugClassLoader::class), \E_USER_DEPRECATED);
/**
...
class DebugClassLoader
{
    ...
    public static function enable()
    {
        ...
        \class_exists(\EbayVendor\Symfony\Component\Debug\ErrorHandler::class);
        \class_exists(\EbayVendor\Psr\Log\LogLevel::class);
