 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests\EventListener;
...
use EbayVendor\Symfony\Component\Console\EventListener\ErrorListener;
use EbayVendor\Symfony\Component\Console\Input\ArgvInput;
use EbayVendor\Symfony\Component\Console\Input\ArrayInput;
use EbayVendor\Symfony\Component\Console\Input\Input;
use EbayVendor\Symfony\Component\Console\Input\InputInterface;
use EbayVendor\Symfony\Component\Console\Input\StringInput;
...
class ErrorListenerTest extends TestCase
{
    ...
    {
        $this->assertEquals(['console.error' => ['onConsoleError', -128], 'console.terminate' => ['onConsoleTerminate', -128]], ErrorListener::getSubscribedEvents());
    }
