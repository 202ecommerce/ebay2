 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests\Question;
...
class ChoiceQuestionTest extends TestCase
{
    ...
    {
        $question = new ChoiceQuestion('A question', ['First response', 'Second response', 'Third response', 'Fourth response']);
