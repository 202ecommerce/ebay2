 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests\Logger;

use EbayVendor\PHPUnit\Framework\TestCase;
use EbayVendor\Psr\Log\LoggerInterface;
use EbayVendor\Psr\Log\LogLevel;
use EbayVendor\Symfony\Component\Console\Logger\ConsoleLogger;
use EbayVendor\Symfony\Component\Console\Output\BufferedOutput;
use EbayVendor\Symfony\Component\Console\Output\OutputInterface;
use EbayVendor\Symfony\Component\Console\Tests\Fixtures\DummyOutput;
/**
 * Console logger test.
 *
...
class ConsoleLoggerTest extends TestCase
{
    ...
    public function provideOutputMappingParams()
    {
        ...
        return [[LogLevel::EMERGENCY, OutputInterface::VERBOSITY_NORMAL, \true], [LogLevel::WARNING, OutputInterface::VERBOSITY_NORMAL, \true], [LogLevel::INFO, OutputInterface::VERBOSITY_NORMAL, \false], [LogLevel::DEBUG, OutputInterface::VERBOSITY_NORMAL, \false], [LogLevel::INFO, OutputInterface::VERBOSITY_VERBOSE, \false], [LogLevel::INFO, OutputInterface::VERBOSITY_VERY_VERBOSE, \true], [LogLevel::DEBUG, OutputInterface::VERBOSITY_VERY_VERBOSE, \false], [LogLevel::DEBUG, OutputInterface::VERBOSITY_DEBUG, \true], [LogLevel::ALERT, OutputInterface::VERBOSITY_QUIET, \false], [LogLevel::EMERGENCY, OutputInterface::VERBOSITY_QUIET, \false], [LogLevel::ALERT, OutputInterface::VERBOSITY_QUIET, \false, $quietMap], [LogLevel::EMERGENCY, OutputInterface::VERBOSITY_QUIET, \true, $quietMap]];
    }
    ...
    {
        $this->assertInstanceOf('EbayVendor\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    {
        $this->expectException('EbayVendor\\Psr\\Log\\InvalidArgumentException');
        $logger = $this->getLogger();
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('EbayVendor\\Symfony\\Component\\Console\\Tests\\Logger\\DummyTest', ['__toString']);
        } else {
            $dummy = $this->createPartialMock('EbayVendor\\Symfony\\Component\\Console\\Tests\\Logger\\DummyTest', ['__toString']);
        }
    ...
    {
        $context = ['bool' => \true, 'null' => null, 'string' => 'Foo', 'int' => 0, 'float' => 0.5, 'nested' => ['with object' => new DummyTest()], 'object' => new \DateTime(), 'resource' => \fopen('php://memory', 'r')];
