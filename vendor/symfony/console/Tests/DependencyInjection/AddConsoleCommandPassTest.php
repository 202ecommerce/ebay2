 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests\DependencyInjection;
...
use EbayVendor\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
use EbayVendor\Symfony\Component\DependencyInjection\ChildDefinition;
use EbayVendor\Symfony\Component\DependencyInjection\Compiler\PassConfig;
use EbayVendor\Symfony\Component\DependencyInjection\ContainerBuilder;
use EbayVendor\Symfony\Component\DependencyInjection\Definition;
use EbayVendor\Symfony\Component\DependencyInjection\TypedReference;
class AddConsoleCommandPassTest extends TestCase
{
    ...
    public function testProcess($public)
    {
        ...
        $container->setParameter('my-command.class', 'EbayVendor\\Symfony\\Component\\Console\\Tests\\DependencyInjection\\MyCommand');
    ...
    {
        $container = new ContainerBuilder();
        $command = $container->register('my-command', MyCommand::class)->setPublic(\false)->addTag('console.command', ['command' => 'my:command'])->addTag('console.command', ['command' => 'my:alias']);
    ...
    {
        $container = new ContainerBuilder();
        $container->register('with-default-name', NamedCommand::class)->setPublic(\false)->addTag('console.command');
        ...
        $container = new ContainerBuilder();
        $container->register('with-default-name', NamedCommand::class)->setPublic(\false)->addTag('console.command', ['command' => 'new-name']);
        $pass->process($container);
    ...
    public function testProcessThrowAnExceptionIfTheServiceIsAbstract()
    {
        ...
        $container->addCompilerPass(new AddConsoleCommandPass(), PassConfig::TYPE_BEFORE_REMOVING);
        $definition = new Definition('EbayVendor\\Symfony\\Component\\Console\\Tests\\DependencyInjection\\MyCommand');
        $definition->addTag('console.command');
    ...
    {
        $container = new ContainerBuilder();
        $className = 'EbayVendor\\Symfony\\Component\\Console\\Tests\\DependencyInjection\\MyCommand';
