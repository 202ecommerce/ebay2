 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests\Command;
...
use EbayVendor\Symfony\Component\Console\Tester\CommandTester;
class CommandTest extends TestCase
{
    ...
    public function testSetApplication()
    {
        ...
        $command = new \EbayVendor\TestCommand();
    ...
    {
        $tester = new CommandTester(new \EbayVendor\TestCommand());
    ...
    {
        $this->expectException('EbayVendor\\Symfony\\Component\\Console\\Exception\\InvalidOptionException');
