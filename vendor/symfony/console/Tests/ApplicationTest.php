 ...
 */
namespace EbayVendor\Symfony\Component\Console\Tests;
...
use EbayVendor\Symfony\Component\Console\DependencyInjection\AddConsoleCommandPass;
use EbayVendor\Symfony\Component\Console\Event\ConsoleCommandEvent;
use EbayVendor\Symfony\Component\Console\Event\ConsoleErrorEvent;
use EbayVendor\Symfony\Component\Console\Event\ConsoleExceptionEvent;
use EbayVendor\Symfony\Component\Console\Event\ConsoleTerminateEvent;
use EbayVendor\Symfony\Component\Console\Exception\CommandNotFoundException;
use EbayVendor\Symfony\Component\Console\Helper\FormatterHelper;
use EbayVendor\Symfony\Component\Console\Helper\HelperSet;
use EbayVendor\Symfony\Component\Console\Input\ArgvInput;
use EbayVendor\Symfony\Component\Console\Input\ArrayInput;
...
use EbayVendor\Symfony\Component\Console\Output\NullOutput;
use EbayVendor\Symfony\Component\Console\Output\Output;
use EbayVendor\Symfony\Component\Console\Output\OutputInterface;
use EbayVendor\Symfony\Component\Console\Output\StreamOutput;
use EbayVendor\Symfony\Component\Console\Tester\ApplicationTester;
use EbayVendor\Symfony\Component\DependencyInjection\ContainerBuilder;
use EbayVendor\Symfony\Component\EventDispatcher\EventDispatcher;
class ApplicationTest extends TestCase
{
    ...
    public function testAll()
    {
        ...
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Command\\HelpCommand', $commands['help'], '->all() returns the registered commands');
        $application->add(new \EbayVendor\FooCommand());
    ...
    public function testAllWithCommandLoader()
    {
        ...
        $commands = $application->all('foo');
        $this->assertCount(1, $commands, '->all() takes a namespace as its first argument');
        $application->setCommandLoader(new FactoryCommandLoader(['foo:bar1' => function () {
            return new \EbayVendor\Foo1Command();
        }]));
        $commands = $application->all('foo');
        $this->assertCount(2, $commands, '->all() takes a namespace as its first argument');
        $this->assertInstanceOf(\EbayVendor\FooCommand::class, $commands['foo:bar'], '->all() returns the registered commands');
        $this->assertInstanceOf(\EbayVendor\Foo1Command::class, $commands['foo:bar1'], '->all() returns the registered commands');
    }
    ...
    {
        $application = new Application();
        $application->add($foo = new \EbayVendor\FooCommand());
        $commands = $application->all();
        $this->assertEquals($foo, $commands['foo:bar'], '->add() registers a command');
        $application = new Application();
        $application->addCommands([$foo = new \EbayVendor\FooCommand(), $foo1 = new \EbayVendor\Foo1Command()]);
        $commands = $application->all();
    ...
    public function testAddCommandWithEmptyConstructor()
    {
        ...
        $application = new Application();
        $application->add(new \EbayVendor\Foo5Command());
    }
    public function testHasGet()
    {
        ...
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Command\\HelpCommand', $command, '->get() returns the help command if --help is provided as the input');
    }
    public function testHasGetWithCommandLoader()
    {
        ...
        $this->assertInstanceOf(\EbayVendor\Foo1Command::class, $foo1 = $application->get('foo:bar1'), '->get() returns a command by name from the command loader');
    ...
    public function testGetNamespaces()
    {
        $application = new Application();
        $application->add(new \EbayVendor\FooCommand());
        $application->add(new \EbayVendor\Foo1Command());
    ...
    public function testFindNamespace()
    {
        ...
        $application->add(new \EbayVendor\Foo2Command());
        $this->assertEquals('foo', $application->findNamespace('foo'), '->findNamespace() returns the given namespace if it exists');
    }
    public function testFindNamespaceWithSubnamespaces()
    {
        $application = new Application();
        $application->add(new \EbayVendor\FooSubnamespaced1Command());
        $application->add(new \EbayVendor\FooSubnamespaced2Command());
    ...
    {
        $application = new Application();
        $application->add(new \EbayVendor\BarBucCommand());
        $application->add(new \EbayVendor\FooCommand());
        $application->add(new \EbayVendor\Foo2Command());
    ...
    {
        $application = new Application();
        $application->add(new \EbayVendor\TestAmbiguousCommandRegistering());
        $application->add(new \EbayVendor\TestAmbiguousCommandRegistering2());
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Command\\HelpCommand', $application->find('h'), '->find() returns a command if its name exists');
    ...
    {
        $application = new Application();
        $application->add(new \EbayVendor\FooSameCaseUppercaseCommand());
        $application->add(new \EbayVendor\FooSameCaseLowercaseCommand());
    ...
    {
        $application = new Application();
        $application->setCommandLoader(new FactoryCommandLoader(['foo:bar' => $f = function () {
            return new \EbayVendor\FooCommand();
        }]));
        $this->assertInstanceOf('FooCommand', $application->find('foo:bar'), '->find() returns a command if its name exists');
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Command\\HelpCommand', $application->find('h'), '->find() returns a command if its name exists');
        $this->assertInstanceOf('FooCommand', $application->find('f:bar'), '->find() returns a command if the abbreviation for the namespace exists');
    ...
    {
        $application = new Application();
        $application->add(new \EbayVendor\Foo3Command());
        $application->add(new \EbayVendor\Foo4Command());
    ...
    public function testFindCommandWithAmbiguousNamespacesButUniqueName()
    {
        $application = new Application();
        $application->add(new \EbayVendor\FooCommand());
        $application->add(new \EbayVendor\FoobarCommand());
    ...
    public function testFindAlternativeExceptionMessageMultiple()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist, with alternatives');
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e);
    ...
    public function testFindAlternativeCommands()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command does not exist');
    ...
    {
        $fooCommand = new \EbayVendor\FooCommand();
        $fooCommand->setAliases(['foo2']);
        $application = new Application();
        $application->setCommandLoader(new FactoryCommandLoader(['foo3' => static function () use($fooCommand) {
            return $fooCommand;
        }]));
    ...
    public function testFindAlternativeNamespace()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if namespace does not exist');
            $this->assertSame([], $e->getAlternatives());
    ...
    public function testFindAlternativesOutput()
    {
        ...
        $application->add(new \EbayVendor\Foo2Command());
        $application->add(new \EbayVendor\Foo3Command());
        $application->add(new \EbayVendor\FooHiddenCommand());
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\CommandNotFoundException', $e, '->find() throws a CommandNotFoundException if command is not defined');
    ...
    {
        $application = $this->getMockBuilder('EbayVendor\\Symfony\\Component\\Console\\Application')->setMethods(['getNamespaces'])->getMock();
    ...
    public function testRenderException()
    {
        ...
        $tester->run(['command' => 'foo'], ['decorated' => \false, 'verbosity' => Output::VERBOSITY_VERBOSE, 'capture_stderr_separately' => \true]);
    ...
    {
        $application = $this->getMockBuilder('EbayVendor\\Symfony\\Component\\Console\\Application')->setMethods(['getTerminalWidth'])->getMock();
        $application->setAutoExit(\false);
    ...
    public function testRun()
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->add($command = new \EbayVendor\Foo1Command());
        $_SERVER['argv'] = ['cli.php', 'foo:bar1'];
        \ob_start();
        $application->run();
        \ob_end_clean();
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Input\\ArgvInput', $command->input, '->run() creates an ArgvInput by default if none is given');
        $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Output\\ConsoleOutput', $command->output, '->run() creates a ConsoleOutput by default if none is given');
        $application = new Application();
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
    ...
    public function testRunReturnsIntegerExitCode()
    {
        ...
        $application = $this->getMockBuilder('EbayVendor\\Symfony\\Component\\Console\\Application')->setMethods(['doRun'])->getMock();
        $application->setAutoExit(\false);
    ...
    public function testAddingOptionWithDuplicateShortcut()
    {
        ...
        $application->register('foo')->setAliases(['f'])->setDefinition([new InputOption('survey', 'e', InputOption::VALUE_REQUIRED, 'My option with a shortcut.')])->setCode(function (InputInterface $input, OutputInterface $output) {
        });
    ...
    public function testAddingAlreadySetDefinitionElementData($def)
    {
        ...
        $application->setAutoExit(\false);
        $application->setCatchExceptions(\false);
        $application->register('foo')->setDefinition([$def])->setCode(function (InputInterface $input, OutputInterface $output) {
        });
        $input = new ArrayInput(['command' => 'foo']);
        $output = new NullOutput();
        $application->run($input, $output);
    ...
    {
        return [[new InputArgument('command', InputArgument::REQUIRED)], [new InputOption('quiet', '', InputOption::VALUE_NONE)], [new InputOption('query', 'q', InputOption::VALUE_NONE)]];
    }
    ...
    {
        $command = new \EbayVendor\FooCommand();
        $application = new Application();
        $application->setAutoExit(\false);
    ...
    {
        $command = new \EbayVendor\FooOptCommand();
        $application = new Application();
        $application->setAutoExit(\false);
        $application->add($command);
        $application->setDefaultCommand($command->getName());
    ...
    public function testRunLazyCommandService()
    {
        ...
        $container->register('lazy-command', LazyCommand::class)->addTag('console.command', ['command' => 'lazy:command'])->addTag('console.command', ['command' => 'lazy:alias'])->addTag('console.command', ['command' => 'lazy:alias2']);
        $container->compile();
        $application = new Application();
    ...
    public function testFindAlternativesDoesNotLoadSameNamespaceCommandsOnExactMatch()
    {
        ...
        $application->setAutoExit(\false);
        $loaded = [];
        $application->setCommandLoader(new FactoryCommandLoader(['foo:bar' => function () use(&$loaded) {
            $loaded['foo:bar'] = \true;
    ...
    public function testCommandNameMismatchWithCommandLoaderKeyThrows()
    {
        ...
        $app = new Application();
        $loader = new FactoryCommandLoader(['test' => static function () {
