...
class HelperSetTest extends TestCase
{
    ...
    public function testGet()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('EbayVendor\\Symfony\\Component\\Console\\Exception\\ExceptionInterface', $e, '->get() throws domain specific exception when helper not found');
    ...
    {
        $mock_helper = $this->getMockBuilder('EbayVendor\\Symfony\\Component\\Console\\Helper\\HelperInterface')->getMock();
