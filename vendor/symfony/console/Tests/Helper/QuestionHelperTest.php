...
use EbayVendor\Symfony\Component\Console\Question\ConfirmationQuestion;
use EbayVendor\Symfony\Component\Console\Question\Question;
use EbayVendor\Symfony\Component\Console\Terminal;
/**
 * @group tty
 */
class QuestionHelperTest extends AbstractQuestionHelperTest
{
    ...
    public function testChoiceOutputFormattingQuestionForUtf8Keys()
    {
        ...
        $output = $this->getMockBuilder('EbayVendor\\Symfony\\Component\\Console\\Output\\OutputInterface')->getMock();
    ...
    public function testTraversableMultiselectAutocomplete()
    {
        ...
        $helperSet = new HelperSet([new FormatterHelper()]);
        $dialog->setHelperSet($helperSet);
        $question = new ChoiceQuestion('Please select a bundle (defaults to AcmeDemoBundle and AsseticBundle)', ['AcmeDemoBundle', 'AsseticBundle', 'SecurityBundle', 'FooBundle'], '0,1');
