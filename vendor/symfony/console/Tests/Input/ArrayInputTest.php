...
class ArrayInputTest extends TestCase
{
    ...
    {
        return [[['foo' => 'foo'], new InputDefinition([new InputArgument('name')]), 'The "foo" argument does not exist.'], [['--foo' => null], new InputDefinition([new InputOption('foo', 'f', InputOption::VALUE_REQUIRED)]), 'The "--foo" option requires a value.'], [['--foo' => 'foo'], new InputDefinition(), 'The "--foo" option does not exist.'], [['-o' => 'foo'], new InputDefinition(), 'The "-o" option does not exist.']];
    }
