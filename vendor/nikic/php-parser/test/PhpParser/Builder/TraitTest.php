...
class TraitTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    ...
    public function testStmtAddition()
    {
        ...
        $prop = new Stmt\Property(Stmt\Class_::MODIFIER_PUBLIC, array(new Stmt\PropertyProperty('test')));
        ...
        $this->assertEquals(new Stmt\Trait_('TestTrait', ['stmts' => [$use, $prop, $method1, $method2, $method3]], ['comments' => [new Comment\Doc('/** Nice trait */')]]), $trait);
    }
    /**
