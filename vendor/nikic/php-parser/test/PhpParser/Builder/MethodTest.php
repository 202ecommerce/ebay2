...
use EbayVendor\PhpParser\Node\Expr\Print_;
use EbayVendor\PhpParser\Node\Scalar\String_;
use EbayVendor\PhpParser\Node\Stmt;
class MethodTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    ...
    public function testReturnByRef()
    {
        ...
        $this->assertEquals(new Stmt\ClassMethod('test', array('byRef' => \true)), $node);
    }
    public function testParams()
    {
        ...
        $this->assertEquals(new Stmt\ClassMethod('test', array('params' => array($param1, $param2, $param3))), $node);
    }
    public function testStmts()
    {
        ...
        $this->assertEquals(new Stmt\ClassMethod('test', array('stmts' => array($stmt1, $stmt2, $stmt3))), $node);
    }
    ...
    public function testReturnType()
    {
        ...
        $this->assertEquals(new Stmt\ClassMethod('test', array('returnType' => 'bool'), array()), $node);
    }
    /**
