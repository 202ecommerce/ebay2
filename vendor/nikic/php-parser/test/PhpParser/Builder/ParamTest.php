...
use EbayVendor\PhpParser\Node\Scalar;
class ParamTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array('array', 'array'), array('callable', 'callable'), array('bool', 'bool'), array('int', 'int'), array('float', 'float'), array('string', 'string'), array('iterable', 'iterable'), array('object', 'object'), array('Array', 'array'), array('CALLABLE', 'callable'), array('EbayVendor\\Some\\Class', new Node\Name('EbayVendor\\Some\\Class')), array('\\Foo', new Node\Name\FullyQualified('Foo')), array('self', new Node\Name('self')), array('?array', new Node\NullableType('array')), array('EbayVendor\\?Some\\Class', new Node\NullableType(new Node\Name('EbayVendor\\Some\\Class'))), array(new Node\Name('EbayVendor\\Some\\Class'), new Node\Name('EbayVendor\\Some\\Class')), array(new Node\NullableType('int'), new Node\NullableType('int')), array(new Node\NullableType(new Node\Name('EbayVendor\\Some\\Class')), new Node\NullableType(new Node\Name('EbayVendor\\Some\\Class'))));
    }
    /**
    ...
    public function testByRef()
    {
        ...
        $this->assertEquals(new Node\Param('test', null, null, \true), $node);
    }
    public function testVariadic()
    {
        $node = $this->createParamBuilder('test')->makeVariadic()->getNode();
        $this->assertEquals(new Node\Param('test', null, null, \false, \true), $node);
    }
}
