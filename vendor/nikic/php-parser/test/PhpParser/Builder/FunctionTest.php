...
class FunctionTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    ...
    public function testReturnByRef()
    {
        ...
        $this->assertEquals(new Stmt\Function_('test', array('byRef' => \true)), $node);
    }
    public function testParams()
    {
        ...
        $this->assertEquals(new Stmt\Function_('test', array('params' => array($param1, $param2, $param3))), $node);
    }
    public function testStmts()
    {
        ...
        $this->assertEquals(new Stmt\Function_('test', array('stmts' => array($stmt1, $stmt2, $stmt3))), $node);
    }
    ...
    public function testReturnType()
    {
        ...
        $this->assertEquals(new Stmt\Function_('test', array('returnType' => 'void'), array()), $node);
    }
    /**
