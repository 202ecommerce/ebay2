...
abstract class ParserTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    /** @returns Parser */
    protected abstract function getParser(Lexer $lexer);
    /**
...
EOC;
        ...
        $fn = $stmts[0];
        $this->assertInstanceOf('EbayVendor\\PhpParser\\Node\\Stmt\\Function_', $fn);
        ...
        $param = $fn->params[0];
        $this->assertInstanceOf('EbayVendor\\PhpParser\\Node\\Param', $param);
        ...
        $echo = $fn->stmts[0];
        $this->assertInstanceOf('EbayVendor\\PhpParser\\Node\\Stmt\\Echo_', $echo);
        ...
        $var = $echo->exprs[0];
        $this->assertInstanceOf('EbayVendor\\PhpParser\\Node\\Expr\\Variable', $var);
