...
class ErrorTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
    ...
    {
        $error = new Error('Some error', array('startFilePos' => $startPos, 'endFilePos' => $endPos));
    ...
    {
        $error = new Error('Some error', array('startFilePos' => 10, 'endFilePos' => 11));
