...
namespace EbayVendor\PhpParser\Unserializer;

use EbayVendor\PhpParser\Comment;
use EbayVendor\PhpParser\Node\Scalar;
class XMLTest extends \EbayVendor\PHPUnit_Framework_TestCase
{
...
XML;
        ...
        $this->assertEquals(new Scalar\String_('Test', array('startLine' => 1, 'comments' => array(new Comment('// comment' . "\n", 2), new Comment\Doc('/** doc comment */', 3)))), $unserializer->unserialize($xml));
    }
