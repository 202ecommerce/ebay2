...
use EbayVendor\PhpParser\Node\NullableType;
...
abstract class BuilderAbstract implements Builder
{
    ...
    protected function normalizeName($name)
    {
        ...
        throw new \LogicException('EbayVendor\\Name must be a string or an instance of PhpParser\\Node\\Name');
    }
    /**
    ...
    protected function normalizeDocComment($docComment)
    {
        if ($docComment instanceof Comment\Doc) {
            ...
            if (\is_string($docComment)) {
                ...
                throw new \LogicException('EbayVendor\\Doc comment must be a string or an instance of PhpParser\\Comment\\Doc');
            }
        }
    }
    /**
