...
namespace EbayVendor\PhpParser\PrettyPrinter;

use EbayVendor\PhpParser\Node;
use EbayVendor\PhpParser\Node\Expr;
use EbayVendor\PhpParser\Node\Expr\AssignOp;
use EbayVendor\PhpParser\Node\Expr\BinaryOp;
use EbayVendor\PhpParser\Node\Expr\Cast;
...
use EbayVendor\PhpParser\PrettyPrinterAbstract;
