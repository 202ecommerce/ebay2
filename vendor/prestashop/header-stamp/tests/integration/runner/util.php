...
{
    $application = new \EbayVendor\Symfony\Component\Console\Application('header-stamp', '9.9.9');
    $command = new \EbayVendor\PrestaShop\HeaderStamp\Command\UpdateLicensesCommand();
