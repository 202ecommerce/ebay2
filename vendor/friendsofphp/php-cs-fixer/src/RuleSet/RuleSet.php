 ...
 */
namespace EbayVendor\PhpCsFixer\RuleSet;
    ...
    public function __construct(array $set = [])
    {
        foreach ($set as $name => $value) {
            ...
            if (!\is_bool($value) && !\is_array($value)) {
                // @TODO drop me on 3.0
                if (null === $value) {
                    Utils::triggerDeprecation(new InvalidFixerConfigurationException($name, 'To disable the rule, use "FALSE" instead of "NULL".'));
                    continue;
                }
