 ...
 */
namespace EbayVendor\PhpCsFixer\Runner;
...
use EbayVendor\PhpCsFixer\Event\Event;
use EbayVendor\PhpCsFixer\FileReader;
use EbayVendor\PhpCsFixer\Fixer\FixerInterface;
use EbayVendor\PhpCsFixer\FixerFileProcessedEvent;
use EbayVendor\PhpCsFixer\Linter\LinterInterface;
use EbayVendor\PhpCsFixer\Linter\LintingException;
use EbayVendor\PhpCsFixer\Linter\LintingResultInterface;
...
final class Runner
{
    ...
    private function dispatchEvent($name, Event $event)
    {
        ...
        if (!$this->eventDispatcher instanceof \EbayVendor\Symfony\Contracts\EventDispatcher\EventDispatcherInterface) {
