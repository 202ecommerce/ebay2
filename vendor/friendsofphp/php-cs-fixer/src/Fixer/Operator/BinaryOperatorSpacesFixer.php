...
', ['operators' => ['=>' => 'align_single_space_minimal']])]);
    ...
    private function resolveOldConfig(array $configuration)
    {
        ...
        Utils::triggerDeprecation(new InvalidFixerConfigurationException($this->getName(), \sprintf('Given configuration is deprecated and will be removed in 3.0. Use configuration %s as replacement for %s.', HelpCommand::toString($newConfig), HelpCommand::toString($configuration))));
        return $newConfig;
    }
