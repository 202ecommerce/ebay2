 ...
 */
namespace EbayVendor\PhpCsFixer\Console\Output;
        ...
        foreach ($errors as $i => $error) {
            ...
            if ($showTrace && !$e instanceof LintingException) {
                ...
                foreach ($stackTrace as $trace) {
                    if (isset($trace['class'], $trace['function']) && \EbayVendor\Symfony\Component\Console\Command\Command::class === $trace['class'] && 'run' === $trace['function']) {
                        $this->output->writeln('      [ ... ]');
                        break;
                    }
