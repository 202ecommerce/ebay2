 ...
 */
namespace EbayVendor\PhpCsFixer\Tokenizer;

use EbayVendor\PhpCsFixer\Tokenizer\Analyzer\GotoLabelAnalyzer;
/**
...
final class TokensAnalyzer
{
    ...
    public function isConstantInvocation($index)
    {
        ...
        if ($this->tokens[$nextIndex]->equalsAny(['(', '{']) || $this->tokens[$nextIndex]->isGivenKind([\T_AS, \T_DOUBLE_COLON, \T_ELLIPSIS, \T_NS_SEPARATOR, CT::T_RETURN_REF, CT::T_TYPE_ALTERNATION, \T_VARIABLE])) {
            return \false;
        }
