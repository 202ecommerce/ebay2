...
final class AccessibleObject
{
    ...
    {
        Utils::triggerDeprecation(new \RuntimeException(\sprintf('The "%s" class is deprecated and will be removed in 3.0 version. Use "php-cs-fixer/accessible-object" package instead.', __CLASS__)));
        $this->object = $object;
