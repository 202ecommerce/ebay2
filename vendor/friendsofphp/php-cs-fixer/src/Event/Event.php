 ...
 */
namespace EbayVendor\PhpCsFixer\Event;

use EbayVendor\Symfony\Component\EventDispatcher\EventDispatcher;
use EbayVendor\Symfony\Contracts\EventDispatcher\EventDispatcherInterface;
// @TODO PHP 7.1
...
if (\is_subclass_of(EventDispatcher::class, EventDispatcherInterface::class)) {
    class Event extends \EbayVendor\Symfony\Contracts\EventDispatcher\Event
    {
    }
} else {
    class Event extends \EbayVendor\Symfony\Component\EventDispatcher\Event
    {
    }
}
