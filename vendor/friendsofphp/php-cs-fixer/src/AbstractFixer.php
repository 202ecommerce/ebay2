 ...
 */
namespace EbayVendor\PhpCsFixer;

use EbayVendor\PhpCsFixer\ConfigurationException\InvalidFixerConfigurationException;
use EbayVendor\PhpCsFixer\ConfigurationException\InvalidForEnvFixerConfigurationException;
use EbayVendor\PhpCsFixer\ConfigurationException\RequiredFixerConfigurationException;
use EbayVendor\PhpCsFixer\Console\Application;
...
use EbayVendor\PhpCsFixer\FixerConfiguration\InvalidOptionsForEnvException;
use EbayVendor\PhpCsFixer\Tokenizer\Tokens;
use EbayVendor\Symfony\Component\OptionsResolver\Exception\ExceptionInterface;
use EbayVendor\Symfony\Component\OptionsResolver\Exception\MissingOptionsException;
/**
...
abstract class AbstractFixer implements FixerInterface, DefinedFixerInterface
{
    ...
    public function configure(array $configuration = null)
    {
        ...
        if (null === $configuration) {
            Utils::triggerDeprecation(new \InvalidArgumentException('Passing NULL to set default configuration is deprecated and will not be supported in 3.0, use an empty array instead.'));
            $configuration = [];
        }
