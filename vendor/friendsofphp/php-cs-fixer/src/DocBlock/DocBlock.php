 ...
 */
namespace EbayVendor\PhpCsFixer\DocBlock;

use EbayVendor\PhpCsFixer\Preg;
use EbayVendor\PhpCsFixer\Tokenizer\Analyzer\Analysis\NamespaceAnalysis;
use EbayVendor\PhpCsFixer\Tokenizer\Analyzer\Analysis\NamespaceUseAnalysis;
/**
...
class DocBlock
{
    ...
    public function makeSingleLine()
    {
        ...
        $usefulLines = \array_filter($this->lines, static function (Line $line) {
