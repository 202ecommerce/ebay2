 ...
 */
namespace EbayVendor\PhpCsFixer\FixerDefinition;
...
final class VersionSpecificCodeSample implements VersionSpecificCodeSampleInterface
{
     ...
     * @param string $code
     */
    public function __construct($code, VersionSpecificationInterface $versionSpecification, array $configuration = null)
    {
