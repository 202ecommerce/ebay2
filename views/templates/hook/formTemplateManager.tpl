	...
	<fieldset>
		...
		<div class="alert alert-info alert-no-icon">
			...
			<ul style="padding-left:15px;">
				...
				<li>{l s='If you can\'t see the pictures of your products, please check if them were correctly generated by PrestaShop. You can try to edit the "Photo Size" field in Advanced Settings as well.' mod='ebay'}</li>
			</ul>
		</div>
