...
class EbayOrderHistoryTab extends EbayTab
{
    ...
    public function getContent()
    {
        ...
        if (!$this->ebay_profile->getConfiguration('EBAY_PAYPAL_EMAIL')) {
            return '<div class="alert alert-warning alert-no-icon">'.$this->ebay->l('Please configure the \'General settings\' tab before using this tab', 'ebayorderhistorytab').'</div>';
        }
