            ...
            foreach ($tasks as $task) {
                ...
                if ($token_for_product) {
                    $vars['task_errors'][] = [
                        ...
                        'desc_error' => $desc,
                        'product_url' => (method_exists($link, 'getAdminLink') ? ($link->getAdminLink('AdminProducts', false, ['id_product' => (int) $product->id]) . '&token=' . $token_for_product . '&id_product=' . (int) $product->id . '&updateproduct') : $link->getProductLink((int) $product->id)),
                    ];
                } else {
                    $vars['task_errors'][] = [
                        'date' => $task['date_upd'],
                        ...
                        'lang_iso' => $context->language->iso_code,
                        'desc_error' => $desc,
                        'product_url' => (method_exists($link, 'getAdminLink') ? ($link->getAdminLink('AdminProducts', false, ['id_product' => (int) $product->id]) . '&token=' . Tools::getAdminTokenLite('AdminProducts') . '&id_product=' . (int) $product->id . '&updateproduct') : $link->getProductLink((int) $product->id)),
                    ];
                }
            }
